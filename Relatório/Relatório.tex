...
\keywords{Amplificador Operacional, Compensador, Linearização, NTC, Ponte de Wheatstone, Pt100, Sensor, Temperatura, Termistor, Termometria}
...
\todo{Tarefa para Casa: para o experimento anterior (item ix) elaborar um gráfico relacionando a Sensibilidade Normalizada como a razão de resistências da ponte - consultar Notas de Aula 03A}
\todo{d. Apresentar a Cadeia de Medida elaborada para este medidor de temperatura baseado em um NTC elaborado pelo grupo}
